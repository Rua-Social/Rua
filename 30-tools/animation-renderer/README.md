...
Animated brand gradient background for the Ecoplex testimonial outro card.
Text is overlaid separately in Final Cut Pro. This renders background only.

Colours are the Ecoplex Sky gradient from the brand book, in brand sequence:
...
| File | Use |
|---|---|
| `ecoplex-outro_ProResHQ.mov` | The one that goes in the FCP timeline |
| `ecoplex-outro_h264.mp4` | Review copy for sending to Victoria |
