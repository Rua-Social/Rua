...
Live open line at time of writing this handoff:

- Chase the Fitzpatrick deposit on a dated thread.

(The Ecoplex send was on the list when the split shipped. It is
not on `todo.md` now. Treat current `todo.md` as source of truth.)
