# Historical desk operating note

Archived on 14 September 2026 when the current desk guidance was reconciled.
The text below is preserved verbatim as history. Model names, availability,
prices, commands and prohibitions describe past sessions and are not current
operating instructions. Use `20-studio/desk.md`, `AGENTS.md` and the relevant
runner README for current work.
